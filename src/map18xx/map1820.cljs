...
(def track-oo {
               ...
               "t248" { "t." "OO" "p." 1 "cZ" [0 2] "cU" [] "vZ" 30}
               "t802" { "t." "OO" "p." 1 "cZ" [0 3] "cU" [] "aZ" "N" "rU" "W" "vZ" 30}
               "t35"  { "t." "OO" "p." 2 "cZ" [0 2] "cU" [1 3] "aU" "S" "vZ" 40 "vU" 40}
               "t36"  { "t." "OO" "p." 2 "cZ" [0 2] "cU" [3 5] "vZ" 40 "vU" 40}
               "t54"  { "t." "OO" "p." 2 "cZ" [0 3] "cU" [1 2] "aZ" "N" "aU" "Q" "vZ" 40 "vU" 40}
               "t64"  { "t." "OO" "p." 2 "cZ" [0 3] "cU" [1 5] "aZ" "T" "aU" "X" "vZ" 30 "vU" 40}
               "t65"  { "t." "OO" "p." 2 "cZ" [0 3] "cU" [1 4] "aZ" "N" "aU" "V" "vZ" 40 "vU" 40}
               "t66"  { "t." "OO" "p." 2 "cZ" [0 2] "cU" [3 4] "vZ" 40 "vU" 40}
               "t67"  { "t." "OO" "p." 2 "cZ" [0 2] "cU" [4 5] "aU" "W" "vZ" 40 "vU" 40}
               "t68"  { "t." "OO" "p." 2 "cZ" [0 1] "cU" [2 3] "aU" "S" "vZ" 40 "vU" 40}
