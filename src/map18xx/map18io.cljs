...
(def app-state {
    ...
    :scale 50
    :tiles [
            { :pos "a5"  :tile "t7"   :orient 2 :color "red" :overlay-punch {"g5" "whiteanchor" "d14" "pinkanchor"} :label {"d9" "20/40/50"}}
            { :pos "a7"  :tile "t7"   :orient 2 :color "grey"}
            { :pos "a21" :tile "t506" :orient 2 :color "red" :overlay-punch {"g5" "pinkanchor" "d14" "whiteanchor"} :label {"d8" "20/40/60" "f9" "East"} }
            ...
            { :pos "c1"  :tile "t507" :orient 0 :label {"f8" "20/50/60" "d6" "West"} :color "red" }
            ...
            { :pos "f2"  :tile "t12"  :orient 0 :color "grey" :label {"d6" "West"}}
            ...
            { :pos "g21" :tile "t507" :orient 3 :color "red" :overlay-punch {"f12" "greenanchor"} :label {"f10" "30/40/50" "c11" "East"}}
            ...
            { :pos "k1"  :tile "t505" :orient 1 :color "red" :overlay-punch {"g7" "greenanchor"} :label {"g11" "West" "d8" "30/50/60"}}
            ...
            { :pos "k19" :tile "t506" :orient 4 :color "red" :overlay-punch {"g9" "greenanchor"} :label {"e11" "30/40/50"}}
